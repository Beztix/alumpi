...
include_once 'global_formValidation.php';


function check_requiredFields_partyRegistrationAsNonGraduate($data_form) {
	$error = "";
...
function check_fieldsFormatting_partyRegistrationAsNonGraduate($data_form) {
