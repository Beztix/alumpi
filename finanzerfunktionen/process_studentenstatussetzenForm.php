...
if(isset($_POST['studentenstatus_setzen'])) {
	...
	//DB-Verbindung erfolgreich
		...
		$stmt = $mysqli->prepare("UPDATE vereinsmitglieder SET iststudent = ? WHERE mid = ?");
		$stmt->bind_param("si", $_POST['studentenstatus'], $_POST['mid']);
		...
		if($stmt->execute()) {
			...
			echo "<p class=\"green\">\n";
			echo "Studentenstatus erfolgreich gesetzt, bitte korrekten Eintrag mittels der Suche nach der MID überprüfen";
			echo "</p>\n";
		}	
