...
?>
				...
				<form action="index.php#result" method="POST" enctype="multipart/form-data">
					...
					<p>
					Bitte überweisen Sie den Betrag von <?php echo ABSOLVENTENFEIER_PREIS_LAUFKARTE; ?> € pro Person bis spätestens 7 Tage vor der Feier auf das Konto des Absolventenvereins.<br>
					<br>
					<u>Kontodaten:</u><br>
